...
//	public static final String TARGET_JAVA_PROJECT = "refactoringExamples/examples/example"+ IdentifyChange.EXAMPLE_NUMBER +"/target";
	public static final String ARQUIVO_CLASSES= FileUtil.getTempPath()+ FILE_SEPARATOR + "classes.txt";
...
//	public static final String JUNIT_FILENAME = "Example" + + "Test";
	public static final String TEMP = System.getProperty("java.io.tmpdir") + FILE_SEPARATOR + "safeRefactorAJ";
	public static final String TEST = TEMP + FILE_SEPARATOR + "tests";
	public static final String TEST_TSE = System.getProperty("java.io.tmpdir") + FILE_SEPARATOR + "safeRefactor" + FILE_SEPARATOR + "tests"+ FILE_SEPARATOR + "bin";
